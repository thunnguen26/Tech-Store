  ...
  const list: InfoItem[] = [
    {
      ...
      content: (
        <>
          <span className="text-indigo-600 font-semibold">iPhone 17 Pro Max</span> mang đến trải nghiệm đỉnh cao với{" "}
          <span className="text-indigo-600 font-semibold">màn hình 6.9" Super Retina XDR</span>{" "}siêu sáng và mượt mà. Sức mạnh từ{" "}
          <span className="text-indigo-600 font-semibold">chip A19 Pro</span>{" "}giúp xử lý mọi tác vụ nhanh chóng, ổn định. Hệ thống{" "}
          <span className="text-indigo-600 font-semibold">camera Pro 48MP</span>{" "}cho khả năng chụp đêm vượt trội và quay video 8K sắc nét.
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <span className="text-indigo-600 font-semibold">Samsung Galaxy S25 Ultra</span> sở hữu trải nghiệm đỉnh cao với{" "}
          <span className="text-indigo-600 font-semibold">màn hình 6.9" Dynamic AMOLED 2X 120Hz</span> siêu mượt và sáng. Hiệu năng vượt trội nhờ{" "}
          <span className="text-indigo-600 font-semibold">chip Snapdragon 8 Elite</span>, xử lý mọi tác vụ nhanh chóng. Hệ thống{" "}
          <span className="text-indigo-600 font-semibold">camera 200MP + zoom 100×</span> giúp bắt trọn mọi khoảnh khắc, quay video 8K sắc nét.
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <span className="text-indigo-600 font-semibold">Apple AirPods Pro 2nd Gen</span> mang đến trải nghiệm âm thanh sống động với{" "}
          <span className="text-indigo-600 font-semibold">Khử ồn chủ động ANC</span> và <span className="text-indigo-600 font-semibold">Adaptive Transparency</span>. 
          Chip <span className="text-indigo-600 font-semibold">H2</span> nâng cao hiệu năng, kết nối ổn định. Hộp sạc <span className="text-indigo-600 font-semibold">MagSafe</span> tiện lợi, hỗ trợ <span className="text-indigo-600 font-semibold">Spatial Audio</span> cho trải nghiệm 3D sống động.
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <span className="text-indigo-600 font-semibold">iPhone 16 128GB</span> mang đến trải nghiệm mượt mà với{" "}
          <span className="text-indigo-600 font-semibold">màn hình 6.7" Super Retina XDR</span> và tần số quét <span className="text-indigo-600 font-semibold">120Hz</span>. 
          Hiệu năng vượt trội nhờ <span className="text-indigo-600 font-semibold">chip A18 Pro</span>, camera <span className="text-indigo-600 font-semibold">48MP</span> chụp đêm sắc nét và quay video <span className="text-indigo-600 font-semibold">8K</span>.
        </>
      ),
    },
  ];
...
// Component Galaxy Ultra Section
  ...
  return (
    <div className="overflow-x-hidden bg-white text-black">
      ...
      <section className="min-h-screen grid grid-cols-1 lg:grid-cols-2 gap-10 items-center px-8 lg:px-16 py-20 relative overflow-hidden">
        ...
        <h5 className="text-6xl lg:text-3xl font-bold mb-6 bg-gradient-to-r from-gray-700 to-black bg-clip-text text-transparent leading-tight">
